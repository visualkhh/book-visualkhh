...
public class GtkParser implements GtkParserConstants {
      ...
      default:
        ...
        throw new ParseException();
                ...
                for (Enumeration e = getClasses().keys(); e.hasMoreElements(); ) {
                        ...
                        clas.setStyle((GtkStyle)getStyles().get(clas.getStyleName()));
                }
  }
  ...
  final public void classDefinition() throws ParseException {
        GtkClass clas = new GtkClass();
    jj_consume_token(CLASS);
    clas.name = readString();
    jj_consume_token(STYLE);
    clas.stylename = readString();
  ...
  final private int[] jj_la1_1 = {0x600000,0x600000,0x0,0x0,0x20000,0x0,0x0,0x3ff,0x3ff,};
